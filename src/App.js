      ...
      <div className="app">
        ...
        <main className="main">
          <div className="page">
            ...
            {tab === "comedy" && <ComedyPage bits={bits} setBits={setBits} />}
          </div>
        </main>
      </div>
    </>
